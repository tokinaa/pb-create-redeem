...
$api->setKey('INI KEY LO');
$api->setWebsiteURL("https://www.pointblank.id/member/signup");
$api->setWebsiteKey("6LedY2IUAAAAAK-55KzamdPZeFh6fbZnDcRhzDLE");
            ...
            if(json_decode($result)->resultCode == "0") {
                ...
                if($otp != '') {
                    ...
                    if(json_decode($result)->resultCode == "0") {
                        ...
                        curl_setopt($ch, CURLOPT_POSTFIELDS, "_viewstate=$resultData&userid=$id&password=$ps&repassword=$ps&email=".urlencode($email)."&code=$otp&g-recaptcha-response=$recaptchaToken");
                        curl_setopt($ch, CURLOPT_HTTPHEADER, [
                            'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:75.0) Gecko/20100101 Firefox/75.0',
